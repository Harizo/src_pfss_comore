(function ()
{
    ...
    angular
        ...
        .controller('QuestionnairemenageController', QuestionnairemenageController);
    /** @ngInject */
    function QuestionnairemenageController($mdDialog, $scope, apiFactory, $state,apiUrl,$http,$cookieStore,serveur_central)  {
        var vm = this;
            ...
            {   
              //recuperation liste variable
                ...
                update : function (e)
                {
                  ...
                  apiFactory.add("liste_variable_menage/index",datas, config).success(function (data)
                  {                
        ...
        return {
          dataSource:
          {
            ...
            transport: {
              ...
              read: function (e)
              {
                apiFactory.getAPIgeneraliserREST("variable_menage/index","cle_etrangere",id_liste_variable).then(function(result)
                {
                    e.success(result.data.response);
                }, function error(result)
                  {
              ...
              update : function (e)
              {
                  ...
                  apiFactory.add("variable_menage/index",datas, config).success(function (data)
                  {                
                    e.success(e.data.models);
