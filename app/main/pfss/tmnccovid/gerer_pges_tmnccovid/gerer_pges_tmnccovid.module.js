(function ()
{
    ...
    angular
        .module('app.pfss.tmnccovid.gerer_pges_tmnccovid', [])
       // .run(notification)
        .config(config);
        var vs = {};
    /** @ngInject */
    ...
    {
        // State
        $stateProvider.state('app.pfss_tmnccovid_gerer_pges_tmnccovid', {
            url      : '/tmnccovid/gerer_pges',
            views    : {
                'content@app': {
        ...
        // Navigation
        msNavigationServiceProvider.saveItem('pfss.tmnccovid.gerer_pges_tmnccovid', {
            title: 'Gérer PGES TMNCCOVID',
            icon  : 'icon-data',
            state: 'app.pfss_tmnccovid_gerer_pges_tmnccovid',
			weight:8,
            //badge:vs,
        });
    }
