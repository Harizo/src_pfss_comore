(function ()
{
    ...
    angular
        ...
        .controller('Formation_thematique_agex_maccController', Formation_thematique_agex_maccController);

    /** @ngInject */
    function Formation_thematique_agex_maccController(apiFactory, $scope, $mdDialog,$state)
    {console.log($state);
        ...
        apiFactory.getAll("Ile/index").then(function(result)
        {
            ...
            apiFactory.getAPIgeneraliserREST("contrat_ugp_agex/index",'id_sous_projet',id_sous_projet_state).then(function(result)
            {
                ...
                apiFactory.getAll("theme_sensibilisation/index").then(function(result)
                {
                    ...
                    apiFactory.getAPIgeneraliserREST("formation_thematique_agex/index","menu","getformation_thematique_agex").then(function(result) { 
