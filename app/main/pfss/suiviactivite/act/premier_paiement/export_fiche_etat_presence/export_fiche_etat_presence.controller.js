(function ()
{
    ...
    angular
        ...
        .controller('Export_fiche_etat_presenceController', Export_fiche_etat_presenceController);

    /** @ngInject */
    function Export_fiche_etat_presenceController(apiFactory, $state, $mdDialog, $scope,$cookieStore,$location,apiUrlExcel,apiUrlExcelimport) {
		var vm = this;
	   vm.dtOptions =
      {
