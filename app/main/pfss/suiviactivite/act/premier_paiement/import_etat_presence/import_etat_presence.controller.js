(function ()
{
    ...
    angular
        ...
        .controller('Import_etat_presenceController', Import_etat_presenceController);

    /** @ngInject */
    function Import_etat_presenceController(apiFactory, $state, $mdDialog, $http, $scope,$location,$cookieStore,apiUrl,apiUrlExcel,apiUrlExcelimport) {
		var vm = this;
	   vm.dtOptions =
      {
      ...
      //initialisation variable
		...
		if(vm.url=='/suivi-activite/act/premier-paiement/enregistrer-etat-de-presence') {
			vm.filtre.titre ="Premier paiement";
			vm.filtre.etape_id = 4;
		} 
		if(vm.url=='/suivi-activite/act/deuxieme-paiement/enregistrer-etat-de-presence') {
