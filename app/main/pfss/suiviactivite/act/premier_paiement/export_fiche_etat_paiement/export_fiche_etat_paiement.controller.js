(function ()
{
    ...
    angular
        ...
        .controller('Export_fiche_etat_paiementController', Export_fiche_etat_paiementController);

    /** @ngInject */
    function Export_fiche_etat_paiementController(apiFactory, $state, $mdDialog, $scope,$cookieStore,$location,apiUrlExcel,apiUrlExcelimport) {
		var vm = this;
	   vm.dtOptions =
      {
      ...
      //initialisation variable
		...
		if(vm.url=='/suivi-activite/act/premier-paiement/export-fiche-etat-de-paiement') {
