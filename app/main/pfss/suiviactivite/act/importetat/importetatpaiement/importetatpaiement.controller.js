(function ()
{
    ...
    angular
        ...
        .controller('ImportetatpaiementController', ImportetatpaiementController);

    /** @ngInject */
    function ImportetatpaiementController(apiFactory, $state, $mdDialog, $http, $scope,$cookieStore,apiUrl,apiUrlExcel,apiUrlExcelimport) {
		var vm = this;
	   vm.dtOptions =
      {
