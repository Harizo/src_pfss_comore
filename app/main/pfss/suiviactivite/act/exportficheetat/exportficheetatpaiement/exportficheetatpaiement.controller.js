(function ()
{
    ...
    angular
        ...
        .controller('ExportficheetatpaiementController', ExportficheetatpaiementController);

    /** @ngInject */
    function ExportficheetatpaiementController(apiFactory, $state, $mdDialog, $scope,$cookieStore,apiUrlExcel,apiUrlExcelimport) {
		var vm = this;
	   vm.dtOptions =
      {
