(function ()
{
    ...
    /** @ngInject */
    function EtatpaiementController(apiFactory, $state, $mdDialog, $scope,$cookieStore,apiUrlExcel,apiUrlExcelimport,$location) {
		var vm = this;
	   vm.dtOptions =
      {
      ...
      //initialisation variable
		...
		if(vm.url=='/suivi-activite/arse/premier-paiement/etat-paiement') {
			vm.filtre.titre =" Premier Tranche";
			vm.filtre.pourcentage =10;
			vm.filtre.montant_a_payer =31500;
		} else if(vm.url=='/suivi-activite/arse/deuxieme-paiement/etat-paiement') {
			vm.filtre.titre =" Deuxième Tranche"
			vm.filtre.pourcentage=70;
			vm.filtre.montant_a_payer =220500;
		} else if(vm.url=='/suivi-activite/arse/troisieme-paiement/etat-paiement') {
			vm.filtre.titre =" Troisième Tranche";
			vm.filtre.pourcentage=20;
			vm.filtre.montant_a_payer =63000;
		}		
      //initialisation variable
