(function ()
{
    ...
    angular
        ...
        .controller('FichepresenceformationController', FichepresenceformationController);

    /** @ngInject */
    function FichepresenceformationController(apiFactory, $state, $mdDialog, $scope,$cookieStore,apiUrlExcel,apiUrlExcelimport) {
		var vm = this;
	   vm.dtOptions =
      {
