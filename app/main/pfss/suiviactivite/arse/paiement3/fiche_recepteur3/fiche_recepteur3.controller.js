(function ()
{
    ...
    angular
        ...
        .controller('Ficherecepteur3Controller', Ficherecepteur3Controller);

    /** @ngInject */
    function Ficherecepteur3Controller(apiFactory, $state, $mdDialog, $scope,$cookieStore,apiUrlExcel,apiUrlExcelimport) {
		var vm = this;
	   vm.dtOptions =
      {
