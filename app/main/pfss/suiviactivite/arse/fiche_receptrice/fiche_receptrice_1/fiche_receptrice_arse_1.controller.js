(function ()
{
    ...
    function FicherecepteurController(apiFactory, $state, $mdDialog, $scope,$cookieStore,apiUrlExcel,apiUrlExcelimport,$location) {
      ...
      //initialisation variable
		...
		vm.loc = $location ;
		vm.url=vm.loc.path();
		if(vm.url=='/suivi-activite/arse/fiche-receptrice/premier-fiche-receptrice') {
		...
		if(vm.url=='/suivi-activite/arse/fiche-receptrice/deuxieme-fiche-receptrice') {
		...
		if(vm.url=='/suivi-activite/arse/fiche-receptrice/troisieme-fiche-receptrice') {
		...
		if(vm.url=='/suivi-activite/covid/fiche-receptrice/premier-fiche-receptrice') {
			vm.filtre.titre =" Premier Tranche";
			vm.filtre.numero_tranche =1;
		...
		if(vm.url=='/suivi-activite/covid/fiche-receptrice/deuxieme-fiche-receptrice') {
			vm.filtre.titre =" Deuxième Tranche";
			vm.filtre.numero_tranche =2;
			vm.filtre.sous_projet=" COVID-19";
		...
		if(vm.url=='/suivi-activite/covid/fiche-receptrice/troisieme-fiche-receptrice') {
			vm.filtre.titre =" Troisième Tranche";
			vm.filtre.numero_tranche =3;
			vm.filtre.sous_projet=" COVID-19";
