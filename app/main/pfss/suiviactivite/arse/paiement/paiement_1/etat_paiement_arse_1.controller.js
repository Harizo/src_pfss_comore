(function ()
{
    ...
    function EtatpaiementController(apiFactory, $state, $mdDialog, $http, $scope,$cookieStore,apiUrlExcel,apiUrlExcelimport,$location,apiUrl,apiUrlbase) {
      ...
      //initialisation variable
		...
		if(vm.url=='/suivi-activite/arse/etat-paiement/premier-paiement') {
			...
			apiFactory.getAPIgeneraliserREST("phaseexecution/index","id",1).then(function(result) {
				...
				vm.filtre.affiche_titre=" Premier Tranche de " + result.data.response[0].pourcentage + "%";
			});
		}
		if(vm.url=='/suivi-activite/arse/etat-paiement/deuxieme-paiement') {
			...
			apiFactory.getAPIgeneraliserREST("phaseexecution/index","id",2).then(function(result) {
				...
				vm.filtre.pourcentage= parseInt(result.data.response[0].pourcentage);
				vm.filtre.tranche= result.data.response[0].Phase;
				vm.filtre.affiche_titre=" Deuxième Tranche de " + result.data.response[0].pourcentage + "%";
			});
		}
		if(vm.url=='/suivi-activite/arse/etat-paiement/troisieme-paiement') {
			...
			apiFactory.getAPIgeneraliserREST("phaseexecution/index","id",3).then(function(result) {
				...
				vm.filtre.pourcentage= parseInt(result.data.response[0].pourcentage);
				vm.filtre.tranche= result.data.response[0].Phase;
				vm.filtre.affiche_titre=" Troisième Tranche de " + result.data.response[0].pourcentage + "%";
			});
		}		
		if(vm.url=='/suivi-activite/covid/etat-paiement/premier-paiement') {
			vm.filtre.titre =" Premier Tranche";
		...
		if(vm.url=='/suivi-activite/covid/etat-paiement/deuxieme-paiement') {
			vm.filtre.titre =" Deuxième Tranche";
		...
		if(vm.url=='/suivi-activite/covid/etat-paiement/troisieme-paiement') {
			vm.filtre.titre =" Troisième Tranche";
