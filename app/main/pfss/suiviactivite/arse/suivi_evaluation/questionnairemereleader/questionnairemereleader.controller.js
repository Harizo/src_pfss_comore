(function ()
{
    ...
    angular
        ...
        .controller('QuestionnairemereleaderController', QuestionnairemereleaderController);
    /** @ngInject */
    function QuestionnairemereleaderController($mdDialog, $scope, apiFactory, $state,apiUrl,$http,$cookieStore,serveur_central)  {
        var vm = this;
            ...
            {   
              //recuperation liste variable
                ...
                update : function (e)
                {
                  ...
                  apiFactory.add("liste_variable_mere_leader/index",datas, config).success(function (data)
                  {                
        ...
        return {
          dataSource:
          {
            ...
            transport: {
              ...
              read: function (e)
              {
                apiFactory.getAPIgeneraliserREST("variable_mere_leader/index","cle_etrangere",id_liste_variable).then(function(result)
                {
              ...
              update : function (e)
              {
                  ...
                  apiFactory.add("variable_mere_leader/index",datas, config).success(function (data)
                  {                
                    e.success(e.data.models);
