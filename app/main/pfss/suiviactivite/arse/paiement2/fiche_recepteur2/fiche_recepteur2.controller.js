(function ()
{
    ...
    angular
        ...
        .controller('Ficherecepteur2Controller', Ficherecepteur2Controller);

    /** @ngInject */
    function Ficherecepteur2Controller(apiFactory, $state, $mdDialog, $scope,$cookieStore,apiUrlExcel,apiUrlExcelimport) {
		var vm = this;
	   vm.dtOptions =
      {
