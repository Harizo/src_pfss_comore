(function ()
{
    ...
    angular
        ...
        .controller('FichepresenceController', FichepresenceController);

    /** @ngInject */
    function FichepresenceController(apiFactory, $state, $mdDialog, $scope,$cookieStore) {
		var vm = this;
	   vm.dtOptions =
      {
     ...
     vm.filtre_region = function()
      ...
      vm.filtre_village = function()
      {
		...
		vm.modifier = function()  {
			...
			vm.filtre.agechefdemenage =  vm.selectedItem.agechefdemenage ;
			...
			vm.filtre.age_conjoint =  vm.selectedItem.age_conjoint ;
