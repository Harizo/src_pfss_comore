(function ()
{
    ...
    angular
        ...
        .controller('Etatpaiement2covidController', Etatpaiement2covidController);

    /** @ngInject */
    function Etatpaiement2covidController(apiFactory, $state, $mdDialog, $scope,$cookieStore,apiUrlExcel,apiUrlExcelimport) {
		var vm = this;
	   vm.dtOptions =
      {
