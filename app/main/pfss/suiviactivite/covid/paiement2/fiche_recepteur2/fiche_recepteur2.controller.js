(function ()
{
    ...
    angular
        ...
        .controller('Ficherecepteur2covidController', Ficherecepteur2covidController);

    /** @ngInject */
    function Ficherecepteur2covidController(apiFactory, $state, $mdDialog, $scope,$cookieStore,apiUrlExcel,apiUrlExcelimport) {
		var vm = this;
	   vm.dtOptions =
      {
