(function ()
{
    ...
    angular
        ...
        .controller('Ficherecepteur3covidController', Ficherecepteur3covidController);

    /** @ngInject */
    function Ficherecepteur3covidController(apiFactory, $state, $mdDialog, $scope,$cookieStore,apiUrlExcel,apiUrlExcelimport) {
		var vm = this;
	   vm.dtOptions =
      {
