(function ()
{
    ...
    angular
        ...
        .controller('Etatpaiement3covidController', Etatpaiement3covidController);

    /** @ngInject */
    function Etatpaiement3covidController(apiFactory, $state, $mdDialog, $scope,$cookieStore,apiUrlExcel,apiUrlExcelimport) {
		var vm = this;
	   vm.dtOptions =
      {
