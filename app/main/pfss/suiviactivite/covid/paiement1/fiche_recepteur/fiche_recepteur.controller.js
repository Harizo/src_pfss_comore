(function ()
{
    ...
    angular
        ...
        .controller('FicherecepteurcovidController', FicherecepteurcovidController);

    /** @ngInject */
    function FicherecepteurcovidController(apiFactory, $state, $mdDialog, $scope,$cookieStore,apiUrlExcel,apiUrlExcelimport) {
		var vm = this;
	   vm.dtOptions =
      {
