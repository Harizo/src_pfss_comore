(function ()
{
    ...
    function MenagebeneficiaireController(apiFactory, $state, $mdDialog, $scope,$rootScope,$cookieStore,$http,$location,apiUrl,apiUrlExcel ,apiUrlbase) {
      ...
      vm.individu_column = [{titre:"Nom et prénom"},{titre:"Date de naissance"},{titre:"Sexe"},{titre:"Lien de parenté"},{titre:"Scolarisé"},{titre:"Activite"},{titre:"Aptitude"}];
      ...
      vm.filtre_village = function()
      {
		...
		vm.modifier_statut = function (etat_statut) {
			if(etat_statut=='PRESELECTIONNE') {
				...
				vm.sort=0;
			} else if(etat_statut=='SORTI') {
				vm.titre_statut="sortir ";
				vm.sort=1;
			} else {	
