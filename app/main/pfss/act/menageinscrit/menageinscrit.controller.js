(function ()
{
    ...
    /** @ngInject */
    function MenageinscritController(apiFactory, $state, $mdDialog, $scope,$cookieStore,$location,apiUrlbase) {
		var vm = this;
	   vm.dtOptions =
      {
      ...
      //initialisation variable
		...
		vm.loc = $location ;
		vm.url=vm.loc.path();
		if(vm.url=='/act/menage-inscrit-act') {
		...
		} else if(vm.url=='/arse/menage-inscrit-arse') {
		...
		} else if(vm.url=='/covid/menage-inscrit-covid-19') {
     ...
     vm.filtre_region = function()
      ...
      vm.filtre_village = function()
      {
		...
		vm.filtrer = function()	{
			vm.affiche_load = true ;
			apiFactory.getAPIgeneraliserREST("menage/index","cle_etrangere",vm.filtre.village_id,"etat_statut","inscrit","id_sous_projet",vm.filtre.id_sous_projet).then(function(result) { 
