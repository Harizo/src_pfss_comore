(function ()
{
    ...
    function notification($cookieStore,apiFactory,$interval,loginService)
    {
        ...
        if (id_user > 0) 
        {
            ...
            apiFactory.getcount_contrat_agep("count_contrat_agep",Number(2)).then(function(result) 
            {
            ...
            apiFactory.getOne("utilisateurs/index", id_user).then(function(result) 
            {
                ...
                if (id_user) 
                {
                    $interval(function(){apiFactory.getcount_contrat_agep("count_contrat_agep",Number(2)).then(function(result) 
                    {
